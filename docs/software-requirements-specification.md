...
This document specifies the software requirements for the No Man's Sky Technology Layout Optimizer (Web UI). This tool is a web-based application that allows users to optimize their technology layouts in the game No Man's Sky.
