...
- **Frontend Framework:** [React](https://react.dev/) (via [Vite](https://vitejs.dev/)) - Modern, fast UI library and build tool.
...
- **UI Testing:** [Storybook](https://storybook.js.org/) - Frontend workshop for building UI components and pages in isolation.
