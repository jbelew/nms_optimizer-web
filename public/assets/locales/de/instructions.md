...
- **Tastatursteuerung:** Navigieren Sie mit den **Pfeiltasten** (↑, ↓, ←, →) und **Pos1** / **Ende**, drücken Sie **S** / **Umschalt+Eingabe** zum Superchargen und **Leertaste** / **Eingabe** zum Aktivieren/Deaktivieren.
