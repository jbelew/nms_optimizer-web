async function createModule(moduleArg = {}) {
	...
	function findWasmBinary() {
		if (Module["locateFile"]) {
			return locateFile("solver.wasm");
		}
		return new URL("solver.wasm", import.meta.url).href;
	}
	...
	function assignWasmExports(wasmExports) {
		___getTypeName = wasmExports["E"];
		_malloc = wasmExports["F"];
		_free = wasmExports["H"];
