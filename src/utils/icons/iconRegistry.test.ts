...
import { getDialogIconAndStyle, radixIconRegistry } from "./iconRegistry";

describe("iconRegistry", () => {
	describe("radixIconRegistry", () => {
		test("should contain expected icons", () => {
			expect(radixIconRegistry).toHaveProperty("CounterClockwiseClockIcon");
			expect(radixIconRegistry).toHaveProperty("DownloadIcon");
			expect(radixIconRegistry).toHaveProperty("ExclamationTriangleIcon");
		});
	});
