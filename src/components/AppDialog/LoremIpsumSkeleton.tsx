		...
		<>
			...
			<Text as="p" mb="4">
				<Skeleton>
					...
					consectetuer lacinia. Nam pretium turpis et arcu. Duis arcu tortor, suscipit
			...
			<Text as="p" mb="4">
				<Skeleton mb="4">
					...
					amet, nonummy id, imperdiet feugiat, pede. Sed lectus. Donec mollis hendrerit
					risus. Phasellus nec sem in justo pellentesque facilisis. Etiam imperdiet
					...
					posuere imperdiet, leo. Maecenas malesuada. Praesent congue erat at massa. Sed
					cursus turpis vitae tortor. Donec posuere vulputate arcu. Phasellus accumsan
...
export default LoremIpsumSkeleton;
