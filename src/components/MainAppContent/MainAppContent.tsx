...
const MainAppContentInternal: FC<MainAppContentInternalProps> = ({ buildVersion }) => {
	...
	return (
		<main className="flex min-h-[100dvh] flex-col items-center justify-center lg:min-h-screen">
			<div
				className="w-full rounded-none shadow-none app backdrop-blur-2xl lg:rounded-xl lg:shadow-xl sm:w-fit"
			...
			>
				...
				>
					<article
						className="w-full gridContainer__container lg:w-auto lg:flex-shrink-0"
						ref={appLayoutContainerRef}
					>
						<header
							className="flex flex-wrap items-center gap-2 mb-3 text-xl heading-styled sm:mb-4 sm:text-2xl"
