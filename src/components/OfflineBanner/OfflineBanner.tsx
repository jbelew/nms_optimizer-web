...
const OfflineBanner: React.FC = () => {
	...
	return (
		<div
			role="alert"
			className="fixed inset-0 z-50 flex h-screen w-screen flex-col items-center justify-center bg-black p-4 text-center text-slate-200"
		>
			<div className="max-w-xl p-8">
				<div className="mb-4 inline-block h-12 w-12">
					{/* SVG from 404.html */}
				...
				<h1 className="offline-title">
					<Trans i18nKey="offline.title" defaults="-kzzkt- Connection Offline! -kzzkt-" />
				</h1>
