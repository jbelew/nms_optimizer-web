...
const setupMocks = (hasTechInGrid: boolean) => {
  mockUseGridStore.mockImplementation((selector?: (state: GridStore) => any) => {
    ...
    mockUseTechStore.mockImplementation((selector?: (state: TechState) => any) => {
  ...
  mockUseShakeStore.mockImplementation((selector?: (state: ShakeState) => any) => {
