...
try {
	...
	const bgImagePath = path.resolve(__dirname, '../public/assets/img/background.webp');
	const outputPath = path.resolve(__dirname, '../public/assets/img/background@mobile-blurred.webp');
	...
	const tempScreenshotPath = path.resolve(__dirname, '../public/assets/img/.temp-screenshot.png');
